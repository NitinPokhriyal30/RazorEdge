...
const solution2Delete = require("./router/solution2Delete");
...
const careerPage = require("./router/careerPage");
...
const PrivacyPolicy = require("./router/PrivacyPolicy");
const Disclaimer = require("./router/Disclaimer");
...
app.use("/solution2-delete", solution2Delete);  
